    ...
    <div className="flex items-center justify-center min-h-screen">
      <Container className="flex flex-col md:flex-row items-center justify-between p-8 bg-white rounded-lg">
        ...
        <div className="w-full md:w-1/2 space-y-4">
          <h1 className="text-3xl font-bold text-center text-[#DB4444] mb-6">Log in to Exclusive</h1>
          ...
          <p className="text-center mt-4">
            Don't have an account? <a href="#" className="text-[#DB4444] font-semibold">Sign Up</a>
          </p>
        </div>
      </Container>
    </div>
